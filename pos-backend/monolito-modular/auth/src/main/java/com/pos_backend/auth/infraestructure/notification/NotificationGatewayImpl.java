...
// Nombre de bean explícito: subscription-service tiene una clase con el
// mismo simple name en su propio paquete de notification — ver el mismo
// comentario en categoria/application/config/UseCaseConfig.java.
@Slf4j
@Component("authNotificationGatewayImpl")
