...
public class FactusHttpClient {
    ...
    // convertidor JSON por autoconfiguración; entre spring-boot-starter-web
    // (Jackson 3, tools.jackson.*) y el jackson-databind clásico que usa
    // este archivo (com.fasterxml.jackson.* — necesario porque la API de
    // Factus se modela con JsonNode clásico) a veces elegía el de Jackson 3
    // y tiraba "Type definition error" al no reconocer
    // com.fasterxml.jackson.databind.JsonNode como uno de sus propios tipos.
    // Se fuerza acá el conversor clásico para este cliente en particular.
